...
# 2.需要能进入这个网址才有用https://moeshare.cc/hack.php?H_name=integral
# 3.cookie设置：
...
# someAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.31 (KHTML, like Gecko) Chrome/103.0.5060.130 Safari/537.36 Edg/103.0.1264.70"
# 可能脚本停止一段时间后才会计入在线时间
