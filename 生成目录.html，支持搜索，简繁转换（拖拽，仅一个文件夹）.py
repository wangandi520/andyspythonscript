...
def main(inputPath):
    ...
    outputFile = outputFile + '，' + time.strftime("%Y%m%d", time.localtime()) + ') ";document.getElementById(\"tips\").innerHTML = \"\";document.getElementById(\"mySearch\").focus();}start();</script>'
