...
# 本脚本使用前提：
# 1.安装python和pip插件，pip install requests，用不了的话搜索pip教程
# 2.能进入萌享会员自由交流区https://moeshare.cc/thread-htm-fid-16.html
# 不能进的话每天14活跃度签到，月底道具中心买全满勤奖后使用
# 3.cookie设置：
# 需要填写下面的myCookie和myAgent
# 萌享首页，chrome或edge按f12，网络，刷新页面，名称里选index.php，右侧请求标头，右键user-agent和cookie，复制值到下面myCookie和myAgent后，别忘了引号。
# f12查看自己的cookie并修改，只需复制8017a_c_stamp=前面的部分，例：
