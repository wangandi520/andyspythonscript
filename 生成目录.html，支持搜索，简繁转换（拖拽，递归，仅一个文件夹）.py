        ...
        if not any(kw in str(loc) for kw in keyWords):
            ...
            if showFolderAndFile and showFileSize:
                ...
                if clickFolder and Path.is_dir(file):
                    ...
                    if addUploadPathEdit and absolutePath:
                        outputFile = outputFile + '<tr><td><a onclick="doClickFile()" href="' + showAddr + '">' + showName + '</td><td>' + showFileSize + '</a></tr>\n'
                    else:
